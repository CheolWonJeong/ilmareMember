...
//		SessInfo sessInfo = sessMgr.getSession(request);
	...
	public  @ResponseBody HashMap HotNewsInsProc(HttpServletRequest request, @RequestPart("imgFile") MultipartFile imgFile, final NewsCommonModel paramModel, Model model) throws Exception {
